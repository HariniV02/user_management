...
class Settings(BaseSettings):
    ...
    # Additional settings (e.g., Mailtrap settings) for flexibility
    mailtrap_host: str = Field(default='smtp.mailtrap.io', description="Mailtrap host address")
    mailtrap_port: int = Field(default=587, description="Mailtrap port for sending emails")
    mailtrap_username: str = Field(default='your-mailtrap-username', description="Username for Mailtrap SMTP server")
    mailtrap_password: str = Field(default='your-mailtrap-password', description="Password for Mailtrap SMTP server")

    send_real_mail: bool = Field(default=False, description="Use mock email or send real email")
