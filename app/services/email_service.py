...
config = ConnectionConfig(
    MAIL_USERNAME="HariniV02",  # Your Mailtrap username
    MAIL_PASSWORD="2015Crunch!!",  # Your Mailtrap password
    MAIL_FROM="hv6@njit.edu",  # The email from which you want to send emails
